...
st.markdown("""This is an interactive visualization of the embeddings of project descriptions. You can see which projects are close to each other, based on the meaning of their description. I've also clustered the project description, finding 5 natural thematic clusters:
            ...
            **2. Document Processing:** These projects use natural language processing (NLP) and other text analysis techniques for tasks like claims processing, creating chatbots, and processing grants. Common keywords include **text analytics** and **virtual agent**. For example, 
            **3. Trend Forecasting:**: These projects use AI for predictive analytics and forecasting. Common keywords include **predictive scenarios** and **seasonal forecasts**. For example, 
            **4. Energy and Physics:** These projects focus on using AI for projects in energy and physics. Common keywords include **energy storage**, **boiler operations**, and **combustion**. For example, the National Energy Technology Laboratory is building an artificial intelligence field laboratory for unconventional resources in the Powder River Basin.
            **5. Health:** These projects focus on drug discovery, clinical applications, and other medical uses of AI. Common keywords include **claims data**, **drug labeling**, and **opioid use**. For example, """)
